                        ...
                        if (err) {
                            ...
                            if ($rootScope.stepDirection && $rootScope.distanceCheck) {
                                ...
                                if (res <= taxiData.company.firstKm) {
                                    ...
                                    statusBarContent = taxiData.company.companyName + " : " + res + " Km - Giá :" + $filter('currency')(Math.round(taxiData.company.firstPrice + (taxiData.company.middleKm - taxiData.company.firstKm) * taxiData.company.firstPrice  + (res - taxiData.company.middleKm) * taxiData.company.lastPrice), "VNĐ");
                                }
