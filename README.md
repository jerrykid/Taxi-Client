...
We used bower to manager all dependencies. 
- To install bower packege 'npm install -g bower'
- To install package by bower: `bower install` to install all dependencies for this app.
...
Read full info at [here!](https://github.com/jerrykid/Taxi-Server)
